...
// void convertHLaserscan2CVMat(const sensor_msgs::LaserScanPtr scan_ranges);
 vector<float> h_depth_vector = scan_ranges; //error here
...
// If statement for enable control ******************************
    ...
    geometry_msgs::Twist control_command_
    control_command_.linear.x = forward_speed; 
    control_command_.angular.x = yr;
...
// Else for zeros to control command ****************************
        ...
        pub_control_commands_.publish(0);
       }
